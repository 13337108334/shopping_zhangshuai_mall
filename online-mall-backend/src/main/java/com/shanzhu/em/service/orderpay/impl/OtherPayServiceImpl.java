...
public class OtherPayServiceImpl extends AbstractPayService {
    ...
    public ResultData<Order> buildParam(PayTypeEnum payTypeEnum, Long id) {
        if (payTypeEnum == null) {
            logger.error("OtherPayServiceImpl buildParam payTypeEnum is null");
        ...
        logger.info("OtherPayServiceImpl buildParam payTypeEnum.value:{}, id:{}", JSON.toJSONString(payTypeEnum.getValue()), JSON.toJSONString(id));
        //todo 其他订单业务逻辑
